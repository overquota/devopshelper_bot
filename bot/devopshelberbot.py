...
def cert(update, context):
    ...
    if feature_status:
        if update.message.reply_to_message is not None:
            context.bot.send_message(
                chat_id=update.message.chat_id,
                text="We have " + "[certification tips]" + "(" + url + ")" + "\.",
                parse_mode="MarkdownV2",
                reply_to_message_id=update.message.reply_to_message.message_id,
                disable_web_page_preview=True,
            )
    ...
    if feature_status:
        if update.message.reply_to_message is not None:
            context.bot.send_message(
                chat_id=update.message.chat_id,
                text="We have "
                + "[job opportunities and cv publish rules]"
                + "("
                + url
                + ")"
...
def chats(update, context):
    ...
    if feature_status:
        if update.message.reply_to_message is not None:
            context.bot.send_message(
                chat_id=update.message.chat_id,
                text="We have " + "[friendly chats list]" + "(" + url + ")" + "\.",
                reply_to_message_id=update.message.reply_to_message.message_id,
                parse_mode="MarkdownV2",
                disable_web_page_preview=True,
            )
...
def events(update, context):
    ...
    if feature_status:
        if update.message.reply_to_message is not None:
            context.bot.send_message(
                chat_id=update.message.chat_id,
                text="Here is your " + "[events list]" + "(" + url + ")" + "\.",
                reply_to_message_id=update.message.reply_to_message.message_id,
                parse_mode="MarkdownV2",
                disable_web_page_preview=True,
            )
...
def summon(update, context):
    ...
    if feature_status:
        if update.message.reply_to_message is not None:
            context.bot.send_message(
                chat_id=update.message.chat_id,
                text="I'm DevOps Bot and i summon you HR for answer: "
                + called_upon
                + " and the question is: "
...
def man(update, context):
    ...
    if feature_status:
        if update.message.reply_to_message is not None:
            ...
            context.bot.send_message(
                chat_id=update.message.chat_id,
                text=triggered_user + " here it is\. " + "\n" + help_file.read(),
                parse_mode="MarkdownV2",
                disable_web_page_preview=True,
            )
            context.bot.deleteMessage(
...
def move(update, context):
    ...
    if feature_status and admins:
        if update.message.reply_to_message.photo:
            ...
            context.bot.send_message(
                chat_id=move_data[0],
                text="Your post " + triggered_user + " was moved to " + move_data[1],
                parse_mode="MarkdownV2",
                disable_web_page_preview=True,
            )
            context.bot.send_message(
                chat_id=move_data[2],
                text="Message was forwarded from: "
                + "@"
                + str(update.message.chat.username)
                + "\n"
                + "Author: "
